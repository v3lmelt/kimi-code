...
export const WORKING_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'ask Hasu to schedule tasks, e.g. "remind me at 5pm"', solo: true, priority: 3 },
...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'shift+tab to cycle modes', priority: 2 },
  { text: 'shift+enter for newline' },
  { text: '/theme to switch themes' },
  { text: '/auto when you want Hasu to handle approvals and keep going unattended', solo: true },
