    ...
    expect(adapted.choices).toEqual([
      {
        ...
        selected_label: 'auto',
        description:
          'Best if you want Hasu to keep working while you are away. Tools are approved automatically, and questions are skipped.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Keep approvals on. Hasu will ask before risky actions, so the goal may stop and wait for you.',
      },
      {
        label: 'Do not start',
        response: 'cancelled',
  ...
  it('renders the yolo-mode /goal start menu for a CreateGoal approval', () => {
    ...
    expect(adapted.choices).toEqual([
      ...
      },
      {
        ...
        selected_label: 'yolo',
        description:
          'Tools and plan changes stay approved automatically. Hasu may still ask you questions.',
      },
      {
        label: 'Do not start',
        response: 'cancelled',
